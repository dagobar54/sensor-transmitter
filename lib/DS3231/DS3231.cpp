...
void DS3231::dtFormat(const char* dateFormat, RTCDateTime dt,char *buffer)
{
    //char buffer[255];
...
void DS3231::dtAlarmFormat(const char* dateFormat, RTCAlarmTime dt,char *buffer)
{
   // char buffer[255];
...
uint8_t DS3231::readStatusReg()
{
	return readRegister8(DS3231_REG_STATUS);
}
uint8_t DS3231::readControlReg()
{
	return readRegister8(DS3231_REG_CONTROL);
}	
